...
export default function App() {
  ...
  return (
    <div
      style={{ display: "flex", flexDirection: "column", gap: "1rem", color: '#fff' }}
      className="App"
    >
      <div style={{ display: "flex", gap: "1rem", color: '#fff', backgroundColor: '#242425' , position: 'sticky', top: 0, width: '100%', justifyContent: 'center', zIndex: 50 }}>
